  ...
  container.innerHTML = `
    <header class="input-sheet__logo">
      <div>
        ...
        <a href="https://www.thoughtworks.com"><img src="${process.env.BASE_URL}/images/tw-logo.png" alt="Thoughtworks logo" /></a>
      </div>
    </header>
    ...
    <main>
      <div id="pdf-cover-page">
        <img class="pdf-banner-image" src="${process.env.BASE_URL}/images/pdf_banner.png" alt="Pdf cover image" width="100%" height="300px" />
        <h1 class="pdf-title"></h1>
        <div class="pdf-powered-by-text">
          <span>Powered by</span>
          <a href="https://www.thoughtworks.com">
            <img class="pdf-tw-logo" src="${process.env.BASE_URL}/images/tw-logo.png" alt="logo" />
          </a>
        </div>
      </div>
