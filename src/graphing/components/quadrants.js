...
function renderRadarLegends(radarElement, hasMovements) {
  ...
  const newImage = legendsContainer
    .append('img')
    .attr('src', `${process.env.BASE_URL}/images/new.svg`)
    .attr('width', '37px')
    .attr('height', '37px')
  ...
  const movedImage = legendsContainer
    .append('img')
    .attr('src', `${process.env.BASE_URL}/images/moved.svg`)
    .attr('width', '37px')
    .attr('height', '37px')
  ...
  const existingImage = legendsContainer
    .append('img')
    .attr('src', `${process.env.BASE_URL}/images/existing.svg`)
    .attr('width', '37px')
    .attr('height', '37px')
  ...
  const noChangeImage = legendsContainer
    .append('img')
    .attr('src', `${process.env.BASE_URL}/images/no-change.svg`)
    .attr('width', '37px')
    .attr('height', '37px')
...
function renderMobileView(quadrant) {
  ...
  quadrantBtn
    ...
    .style('background-image', `url('${process.env.BASE_URL}/images/${quadrant.order}-quadrant-btn-bg.svg')`)
