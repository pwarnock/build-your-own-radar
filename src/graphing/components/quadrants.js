...
function renderRadarLegends(radarElement, hasMovements) {
  ...
  const newImage = legendsContainer
    .append('img')
    .attr('src', '/build-your-own-radar/images/new.svg')
    .attr('width', '37px')
    .attr('height', '37px')
  ...
  const movedImage = legendsContainer
    .append('img')
    .attr('src', '/build-your-own-radar/images/moved.svg')
    .attr('width', '37px')
    .attr('height', '37px')
  ...
  const existingImage = legendsContainer
    .append('img')
    .attr('src', '/build-your-own-radar/images/existing.svg')
    .attr('width', '37px')
    .attr('height', '37px')
  ...
  const noChangeImage = legendsContainer
    .append('img')
    .attr('src', '/build-your-own-radar/images/no-change.svg')
    .attr('width', '37px')
    .attr('height', '37px')
...
function renderMobileView(quadrant) {
  ...
  quadrantBtn
    ...
    .style('background-image', `url('/build-your-own-radar/images/${quadrant.order}-quadrant-btn-bg.svg')`)
